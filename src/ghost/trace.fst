...
module Tesseract.Ghost.Trace
   ...
   type _event_g (key_t: Type) (substate_t: Type) (subevent_t: Type) =
      | Spawn: 
         key: key_t -> step: Subtrace.transform_g substate_t subevent_t 
            -> substate0: substate_t 
            -> _event_g key_t substate_t subevent_t
      | Service: 
         key: key_t -> subevent: subevent_t 
            -> _event_g key_t substate_t subevent_t

   type is_event_safe: 
      #key_t: Type -> #substate_t: Type -> #subevent_t: Type
         -> state: state_g key_t substate_t subevent_t -> event: _event_g key_t substate_t subevent_t
         -> Type =
      fun (key_t: Type) (substate_t: Type) (subevent_t: Type) state event ->
   ...
   (*type event_g (key_t: Type) (substate_t: Type) (subevent_t: Type) (state: state_g key_t substate_t subevent_t) =
      state: state_g key_t substate_t subevent_t -> event: _event_g key_t substate_t subevent_t{is_event_safe state event}*)
   ...
   let init (key_t: Type) (substate_t: Type) (subevent_t: Type) =
      Subtrace.init 
         (transform) 
         ({
            ordinal = 0;
